...
<head>
    ...
    <title>@yield('title', 'Support Desk') — Volamani</title>
    ...
    <style>
        :root {
            --vl-sidebar-bg: #0b3d3a;
            --vl-sidebar-hover: rgba(255,255,255,0.08);
            --vl-sidebar-active: #14b8a6;
...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        <a href="{{ route('support.dashboard') }}" class="sidebar-brand">
            ...
            Volamani
            <span class="badge bg-teal text-white ms-auto" style="background:#14b8a6;">Support</span>
        </a>

        <div class="py-2">
            <span class="nav-section">Overview</span>
            <a href="{{ route('support.dashboard') }}" class="nav-link {{ active_route('support.dashboard') }}">
                <i class="bi bi-speedometer2"></i> Dashboard
            </a>

            <span class="nav-section">Customer Care</span>
            <a href="{{ route('support.disputes.index') }}" class="nav-link {{ active_prefix('support/disputes') }}">
                <i class="bi bi-life-preserver"></i> Support Tickets
            </a>
            <a href="{{ route('support.returns.index') }}" class="nav-link {{ active_prefix('support/returns') }}">
                <i class="bi bi-arrow-return-left"></i> Returns &amp; Refunds
            </a>
            <a href="{{ route('support.kyc.index') }}" class="nav-link {{ active_prefix('support/kyc') }}">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="dropdown">
                    <button class="btn btn-sm d-flex align-items-center gap-2" data-bs-toggle="dropdown">
                        <img src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name) }}&size=32&background=0b3d3a&color=fff"
