...
<div class="container-fluid py-4">
    <a href="{{ route('admin.kyc.index') }}" class="text-decoration-none small">&larr; Back to KYC queue</a>
                            ...
                            @foreach($docs as $field => $path)
                                <div class="col-md-6">
                                    <div class="border rounded p-3 d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="{{ route('admin.kyc.document', [$kyc, $field]) }}" target="_blank" class="btn btn-sm btn-outline-primary">View</a>
                                    </div>
                                </div>
                            @endforeach
                        </div>
            ...
            @if($kyc->canReview())
                <div class="card border-0 shadow-sm mb-3">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.kyc.approve', $kyc) }}" method="POST" class="mb-3"
