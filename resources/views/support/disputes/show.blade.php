...
@section('title', 'Ticket ' . $dispute->reference)

@section('content')
@php($escrow = $dispute->escrow)
<div class="container-fluid">
    <a href="{{ route('support.disputes.index') }}" class="text-decoration-none small">&larr; Back to tickets</a>
            ...
            <div class="card border-0 shadow-sm">
                ...
                @if($dispute->isOpen())
                    <div class="card-footer bg-white">
                        <form action="{{ route('support.disputes.message', $dispute) }}" method="POST" enctype="multipart/form-data">
                            @csrf
            ...
            @else
                <div class="card border-0 shadow-sm mb-3">
                    <div class="card-body">
                        ...
                        <form action="{{ route('support.disputes.resolve', $dispute) }}" method="POST"
                ...
                @if($dispute->canBeEscalated())
                    <form action="{{ route('support.disputes.escalate', $dispute) }}" method="POST">
                        @csrf
