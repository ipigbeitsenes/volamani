    ...
    public function run(): void
    {
        $plans = [
            ...
            [
                ...
                'price' => 250000,      // 2,500.00 / mo (minor units)
                'billing_interval' => 'monthly',
            ...
            [
                ...
                'price' => 750000,      // 7,500.00 / mo (minor units)
                'billing_interval' => 'monthly',
            ...
            [
                ...
                'price' => 7500000,     // 75,000.00 / yr (minor units)
        ...
        foreach ($plans as $plan) {
            SubscriptionPlan::firstOrCreate(['slug' => Str::slug($plan['name'])], $plan);
        }
