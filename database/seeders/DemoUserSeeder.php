...
class DemoUserSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $users = [
            ...
            ['Sarah Mitchell', 'chioma@example.com', 'chioma', 'buyer', 50_000_00],
            ['James Carter',   'tunde@example.com',  'tunde',  'buyer', 30_000_00],
            ['Emma Wilson',    'amaka@example.com',  'amaka',  'buyer', 20_000_00],

            // Vendors
            ['Pixel Forge',     'pixel@example.com',      'pixelforge', 'vendor', 0],
            ['Northwind Studio', 'naijadev@example.com',   'naijadev',   'vendor', 0],
            ...
            ['Alex Turner',   'adeola@example.com', 'adeola', 'consultant', 0],
            ['Michael Reed',  'emeka@example.com',  'emeka',  'consultant', 0],
        ];
