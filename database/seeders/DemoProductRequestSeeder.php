...
class DemoProductRequestSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $requests = [
            ['chioma@example.com', 'Need a logo for my fashion brand', 'Looking for a modern, minimal logo and brand colours for a women’s fashion label.', 5_000_00, 15_000_00, 'Lagos'],
            ['tunde@example.com', 'Build a simple e-commerce website', 'I need a small online store with Paystack checkout and product management.', 30_000_00, 80_000_00, 'Abuja'],
